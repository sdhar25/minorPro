...
if(isset($_POST['edit']))
{
  ...
  $_SESSION['id']=$key;
  //echo $key;
  $query = "SELECT * FROM digitalprogram where id='$key'";
...
<?php
  if($_POST['submit'])
  {
    ...
    {
      $query = "UPDATE digitalprogram SET title='$title' where id='$id'";
      $data1=mysqli_query($conn,$query);
    }
    if(isset($_POST['details']))
    {
      $query = "UPDATE digitalprogram SET details='$details' where id='$id'";
      ...
      {
         $query = "UPDATE digitalprogram SET title='$title', details='$details', picsource='$folder' where id='$id'";
      ...
      ?>
  		 <script>
       window.location.href='adminDEP.php';
       </script>
  	<?php
  	 }
  	 else
