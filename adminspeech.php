           		         ...
           		         <tbody>
                              ...
                              while($result5=mysqli_fetch_assoc($data5))
                              {
                              	echo "<tr>
                               	...
                               	<td><a href='editSpeechCarousel.php?edit_id=$result5[id]&bd=$result5[bigdata]&sd=$result5[smalldata]&ps=$result5[picsource]'>EDIT</a></td>
                               	</tr>";
                              }
           		         	?>
           		         </tbody>
                        ...
                        while ($result=mysqli_fetch_assoc($data))
                         {
                        	...
                        	<td><a href='editSpeechintro.php?id=$result[id]&txt=$result[intro]'>EDIT</a></td>
                        	</tr>";
                        }
					?>
				</tbody>
...
<div class="subject" id="subject">
	<div class="container">
		<?php
		$query_sub="SELECT * FROM speechsub";
				...
				<tbody>
					<?php
                       while($result_sub=mysqli_fetch_assoc($data_sub))
                       {
                        	...
                        	<td><a href='editSpeechsub.php?id=$result_sub[id]&cc=$result_sub[coursecode]&cn=$result_sub[coursename]&cd=$result_sub[coursedu]'>EDIT</a></td>
                        	</tr>";
                       }
					?>
				</tbody>
	...
	<div class="container">
		<?php
		  ...
		  ?>
            ...
            <!--first year begin-->
                <?php
                    $query2="SELECT * FROM bsdiplomafirst";
                                  ...
                                  while($result2=mysqli_fetch_assoc($data2))
			                       {
			                        	...
			                        	<td><a href='editSpeechFirst.php?id=$result2[id]&sc=$result2[subjectcode]&sub=$result2[subject]'>EDIT</a></td>
			                        	</tr>";
			                       }
                      			?>
                      		</tbody>
            ...
            <!--second year begins-->
               <?php
                    $query3="SELECT * FROM bsdiplomasec";
                                  ...
                                  while($result3=mysqli_fetch_assoc($data3))
			                       {
			                        	...
			                        	<td><a href='editSpeechSec.php?id=$result3[id]&sc=$result3[subjectcode]&sub=$result3[subject]'>EDIT</a></td>
			                        	</tr>";
			                       }
                      			?>
                      		</tbody>
