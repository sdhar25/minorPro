...
<div class="carou" id="carou">
	...
	<h1 class="display-5 text-center">CAROUSEL IMAGES</h1>
	  <?php
        $query5="SELECT * FROM firstaidcar";
           		         ...
           		         <tbody>
                              ...
                              while($result5=mysqli_fetch_assoc($data5))
                              {
                              	echo "<tr>
                               	...
                               	<td><a href='editFirstAidCarousel.php?edit_id=$result5[id]&bd=$result5[bigdata]&sd=$result5[smalldata]&ps=$result5[picsource]'>EDIT</a></td>
                               	</tr>";
                              }
           		         	?>
           		         </tbody>
...
<div class="maintext" id="maintext">
	<div class="container">
		<?php
		$query1="SELECT * FROM firstaidtext";
                        ...
                        while ($result1=mysqli_fetch_assoc($data1))
                         {
                        	...
                        	<td><a href='editFirstAidText.php?id=$result1[id]&txt=$result1[intro]'>EDIT</a></td>
                        	</tr>";
                        }
					?>
				</tbody>
