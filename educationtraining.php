...
<?php
                  function make_query($con)
                  {
                       ...
                       $query="SELECT * from edutraincar ORDER BY id ASC";
...
?>
              ...
              <div class="ml-5 mr-4">
                ...
                <div class="jumbotron ml-5 mr-4">
			              <h1 class="display-5 text-center"><u>Education & Training</u> </h1>
			              
			              <p class="lead">
			                    <?php

					               $query="SELECT maintext from edutraitext";
			                    ...
			                    <?php
					               ...
					               $query="SELECT listtext from edutraitext";
							       $data=mysqli_query($con,$query);
							       $total=mysqli_num_rows($data);
							       if($total!=0)
			                       {
