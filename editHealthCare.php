		 ...
		 <form action="" method="GET">
		 	...
		 	<div class="col-md-6">
		 		<div class="form-group">
		 			...
		 			<textarea class="form-control" rows="5"  name="healthcaretxt" required=""><?php echo (nl2br($_GET['txt']));?></textarea>
		 		</div>
...
<?php
   ...
   {
     $id=$_GET['id'];
     $healthcaretxt=$_GET['healthcaretxt'];
     $query="UPDATE healthcaretext SET healthcaretxt='$healthcaretxt' WHERE id=$id ";
