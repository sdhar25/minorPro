     ...
     function make_query($con)
                  {
                       ...
                       $query="SELECT * from firstaidcar ORDER BY id ASC";
...
<div class="maintext" id="maintext">
              	<div class="container">
                 <h1 class="display-5 text-center wow fadeInUp" data-wow-delay="0.8s">FIRST AID PROGRAM</h1>             
                  
                  	<div class="row col-lg-12">
                  		<div class="text-justified wow fadeInRight" data-wow-delay="1.2s">
                   <?php

		               $query="SELECT * from firstaidtext";
