...
<?php
                  function make_query($con)
                  {
                       ...
                       $query="SELECT * from bastrocar ORDER BY userID ASC";
		           ...
		           function make_slide_indicator($con)
						...
						function make_slide($con)
						{
							...
							while($row = mysqli_fetch_array($result))
							{
								...
								$output .='
								<img src="'.$row["userPic"].'"class="img-fluid" width=""">
...
?>
     <div class="container-fluid col-md-12 col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="maintext" id="maintext">
                    <div class="container">
			              <h1 class="display-5 text-center wow fadeInUp">BASTRO BANK</h1>
			              <p class="lead">
