...
<?php
                  function make_query($con)
                  {
                       ...
                       $query="SELECT * from physiocar ORDER BY id ASC";
              ...
              <div class="container-fluid">
                ...
                <div class="container">
                   <div class="maintext" id="maintext">
			              <h1 class="display-5 text-center">Diploma And Certification Program On Physiotherapy</h1>
						    ...
						    <div class="card">
						      ...
						      <div class="card-header">
						        <a class="card-link" data-toggle="collapse" href="#collapseOne">
						        	...
						        	<?php
								          $query="SELECT * from physiosub where id=1";
									       $data=mysqli_query($con,$query);
									       $total=mysqli_num_rows($data);
									       if($total!=0)
					                       {
                                ...
                                <?php
				                    ...
				                    ?>
			                                ...
			                                <?php
			                                       ...
			                                       $query4="SELECT * from diplomafirst";
                            ...
                            <div class="card">
						      <div class="card-header">
						        <a class="card-link" data-toggle="collapse" href="#collapseTwo">
						        	...
						        	<?php
								          $query2="SELECT * from physiosub where id=2";
									       ...
									       {
									       	echo "<i class='fa fa-angle-down'></i>".$result2['coursename'];
						        	?>						          
						        </a>
						      </div>
						      ...
						      <div class="card-body">
                               <?php
						       	echo "<b><i>Course Code- </i></b>".$result2['coursecode'];
                                echo "<br><br/><b><i>Course Duration- </i></b>".$result2['coursedu'];
                                ?>
                                ...
                                <?php
				                    ...
				                    ?>
				                             ...
				                             <?php
			                                       ...
			                                       $query4="SELECT * from physiostudytbl2";
											       $data4=mysqli_query($con,$query4);
											       $total4=mysqli_num_rows($data4);
