		 ...
		 <form action="" method="GET">
		 	...
		 	<div class="col-md-6">
		 		<div class="form-group">
		 			...
		 			<textarea class="form-control" rows="15"  name="intro" required=""><?php echo (nl2br($_GET['txt']));?></textarea>
		 		</div>
		 		<div class="col-md-6">
...
<?php
   if($_GET['submit'])
   {
     $id=$_GET['id'];
     $intro=$_GET['intro'];
     $query="UPDATE medteamtext SET intro='$intro' WHERE id=$id ";
     $data=mysqli_query($con,$query);
     if($data)
     {
         echo "<script>
               alert('Data updated');
               window.location.assign('adminMedicalTeam.php');
         </script>";
     }
     else
     {
